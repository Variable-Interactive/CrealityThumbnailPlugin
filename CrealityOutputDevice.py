...
class Save_File(OutputDevice):
    ...
    def save_gcode(self, file_name, _gcode):
        ...
        try:
            ...
            if True:
                ...
                save_file.write(self.add_screenshot(ssnapshot, 48, 48, 'jpg', file_dir))
                save_file.write('\n')
                save_file.write(self.add_screenshot(bsnapshot, 200, 200, 'jpg', file_dir))
                save_file.write("\n")
            for line in _gcode:
    ...
    def add_screenshot(self, img, width, height, img_type, file_folder):
        currentPath = os.path.join(file_folder, "preview.jpg")
